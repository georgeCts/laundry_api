                            ...
                            <tbody>
                                @foreach($lstServices as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->status == "ACCEPTED")
                                                <a href="/panel/servicios/configurar/{{ $item->id }}" class="btn btn-sm btn-dark">Iniciar servicio</a>
                                            @else
                                                <a href="/panel/servicios/configurar/{{ $item->id }}" class="btn btn-sm btn-light">Finalizar servicio</a>
                                            @endif
